...
UI::UI(uint16_t width, uint16_t height)
    : buffer(width, height), sizeX(8), sizeY(8), width(width), height(height),
      ...
      quarter((maxPosSide3 + 1) / 4), userMessageOriginX(85),
      userMessageOriginY(80), userMessageDxMin(-20), userMessageDxMax(20) {
